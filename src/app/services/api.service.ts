...
export class ApiService {
  ...
  pourDrink(selectedPump: string) {
    return this.http.get(`${this.baseURI}/pourdrink/${selectedPump}`);
  }

  stopPump(selectedPump: string) {
    return this.http.get(`${this.baseURI}/stoppump/${selectedPump}`);
  }
